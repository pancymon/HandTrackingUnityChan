...
namespace Mediapipe.Unity
{
  public class MultiHandLandmarkListAnnotationController : AnnotationController<MultiHandLandmarkListAnnotation>
  {
    ...
    private HandToAnimation _handToAnimation=null;
    ...
    protected override void SyncNow()
    {
      ...
      if(_handToAnimation == null)
      {
        _handToAnimation=FindObjectOfType<HandToAnimation>();
      }

      if(_handToAnimation!=null)
      {
        Debug.Log("hand to animation not null");
        _handToAnimation.Render(_currentHandLandmarkLists);
      }
